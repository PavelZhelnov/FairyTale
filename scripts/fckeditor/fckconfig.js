...
//FCKConfig.BaseHref = 'http://fairytale.com.ua/scripts/fckeditor/' ;
FCKConfig.BaseHref = 'http://localhost/fairytale/scripts/fckeditor/' ;
...
FCKConfig.ImagePath = FCKConfig.BasePath + '/../../i/useruploads/' ;
...
FCKConfig.ToolbarSets["Default"] = [
	['Source'],['Cut','Copy','Paste','-','Undo','Redo','-','Find','Replace','-','SelectAll'],
...
FCKConfig.LinkBrowserURL = FCKConfig.BasePath + 'filemanager/browser/default/browser.html?Connector=connectors/php/connector.php&ServerPath=/CustomFiles/' ;
FCKConfig.LinkBrowserWindowWidth	= screen.width * 0.7 ;	// 70%
FCKConfig.LinkBrowserWindowHeight	= screen.height * 0.7 ;	// 70%

FCKConfig.ImageBrowser = true ;
//FCKConfig.ImageBrowserURL = FCKConfig.BasePath + 'filemanager/browser/default/browser.html?Type=Image&Connector=connectors/asp/connector.asp&ServerPath='+'../../i';
...
FCKConfig.ImageBrowserURL = FCKConfig.BasePath + 'filemanager/browser/default/browser.html?Type=Image&Connector=connectors/php/connector.php&ServerPath='+'../../i/useruploads/' ;
