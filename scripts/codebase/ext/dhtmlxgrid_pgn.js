...
dhtmlXGridObject.prototype.enablePagingWT = function(fl,pageSize,pagesInGrp,parentObjId){
 ...
 this.aToolBar.setOnClickHandler(function(btnId,val){
 if(btnId=="leftabs"){
 self.changePage(1)
}else if(btnId=="left"){
 self.changePage(self.currentPage-1)
}else if(btnId=="rightabs"){
 ...
 if(this._WTDef[0]){
 this.aToolBar.addItem(new dhtmlXImageButtonObject(this.imgURL+'ar_left_abs.gif',18,18,0,'leftabs','To First Page'))
 this.aToolBar.addItem(new dhtmlXImageButtonObject(this.imgURL+'ar_left.gif',18,18,0,'left','Previous Page'))
}
 if(this._WTDef[1])
 ...
 if(this._WTDef[0]){
 this.aToolBar.addItem(new dhtmlXImageButtonObject(this.imgURL+'ar_right.gif',18,18,0,'right','Previous Page'))
 this.aToolBar.addItem(new dhtmlXImageButtonObject(this.imgURL+'ar_right_abs.gif',18,18,0,'rightabs','To Last Page'))
}
 if(this._WTDef[2])
 this.aToolBar.addItem(new dhtmlXSelectButtonObject("pages","null","null","",120,18,"toolbar_select"));
 if(this._WTDef[3])
 this.aToolBar.addItem(new dhtmlXSelectButtonObject("perpagenum","5,10,15,20,25,30","5"+this._WTlabels[4]+",10"+this._WTlabels[4]+",15"+this._WTlabels[4]+",20"+this._WTlabels[4]+",25"+this._WTlabels[4]+",30"+this._WTlabels[4]+"","",120,18,"toolbar_select"));
