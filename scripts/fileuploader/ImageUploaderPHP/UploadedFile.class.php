...
class UploadedFile {
  ...
  public function getSourceXResolution() {
    return $this->_package->getPackageField(sprintf(PostFields::sourceXResolution, $this->_index));
  }

  public function getSourceYResolution() {
    return $this->_package->getPackageField(sprintf(PostFields::sourceYResolution, $this->_index));
  }
