    ...
    AU.amazonS3Extender.prototype = {
        ...
        accessKeyId: function (value) {
            ...
            if (arguments.length == 0) {
                ...
                return this._accessKeyId = value;
            }
        },
        bucketHostName: function (value) {
            ///	<summary>
            ///		Get or set bucket host name
            ///	</summary>
            ///	<param name="value" type="String">
            ///		Bucket host name. "s3.amazonaws.com" will be used if not specified.
            ///	</param>
            ///	<returns type="String" />
            if (arguments.length == 0) {
                return this._bucketHostName;
            } else {
                return this._bucketHostName = value;
            }
        },
