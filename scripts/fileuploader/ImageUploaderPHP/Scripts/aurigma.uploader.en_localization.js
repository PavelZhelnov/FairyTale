var en_localization = {
    ...
    folderPane: {
        ...
        headerAllText: "Total files: [count], ",
        headerAllowedText: "allowed: [count]"
    },
    imageEditor: {
        cancelButtonText: "Cancel",
    ...
    messages: {
        ...
        unexpectedError: "Image Uploader encountered some problem. If you see this message, contact web master.",
