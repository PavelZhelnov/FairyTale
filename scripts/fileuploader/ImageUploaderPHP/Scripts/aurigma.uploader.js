(function(wnd) {
    var axVERSION = '7.0.11.0', jVERSION = '7.0.11.0';
var 
// Will speed up references to undefined, and allows munging its name.
UNDEF,
// Global entry
AU = wnd.Aurigma ? (wnd.Aurigma.ImageUploader || {}) : {},

objectCache = AU._objectCache || {
    _cache: {},
    _uid: 0,
    put: function (obj) {
...
propertyMaker = {
        ...
        if (typeof property.name === 'string' && !property.renderOnly) {
            try {
                ...
                obj[property.name] = function () {
                    // set value if we pass parameter
                    if (arguments.length > 0) {
                        if (!(setter in element)) {
                            showError('Control have not "' + setter + '" property.');
                            return null;
                        }
                        return element[setter](arguments[0]);
                    } else {
                        if (!(getter in element)) {
                            showError('Control have not "' + getter + '" property.');
                            return null;
                        }
    ...
    createAttributeProperty: function (obj, property) {
        ...
        ///	    The object which contains method name and defaut value.
        ///	</param>
        var uploader = obj._uploader, element = uploader.getElement(), type = uploader.type();
        if (!property.platform || property.platform == type) {
            obj[property.name] = function () {
                // set value if we pass parameter
                if (arguments.length > 0) {
    ...
    getJREs: function () {
        if (this.list == null) {
            ...
            if (javaPlugin && javaPlugin.jvms) {
                ...
                if (typeof wnd.java !== 'undefined' && wnd.java.lang) {
...
AU.activeXControl.prototype = {
    ...
    _simpleProperties: [
        { name: "codeBase", defaultValue: "Scripts/ImageUploader7.cab", isAttribute: true, platform: 'activex' },
        { name: "classId", defaultValue: "517BE9E4-0B43-4B36-95BA-AE0611546427", isAttribute: true, platform: 'activex' },
        { name: "progId", defaultValue: "Aurigma.Uploader.7", isAttribute: true, platform: 'activex' },
        { name: "version", isAttribute: true, platform: 'activex', defaultValue: axVERSION }
    ],
    ...
    isActiveXSupported: function () {
        return (typeof wnd.ActiveXObject !== 'undefined'); // True if window.ActiveXObject exists.
    },
    actualVersion: function () {
        var el = this._uploader.getElement();
        if (el) {
            return el.getActualVersion();
        } else {
            return null;
        }
    },
    ...
    version: function (value) {
        ///	<summary>
        ///		Gets or sets minimum required version of the ActiveX control (ImageUploader6.cab file).
        ///	</summary>
        ///	<param name="value" type="String">
...
AU.activeXControl.init = propertyMaker._typicalInit;
AU.activeXControl.reinit = propertyMaker._typicalReinit;
...
extend(AU.events.prototype, {
    _eventNames: [UNDEF /*base event - initComplete*/, UNDEF/*base event - preRender*/,
        "afterPackageUpload",
        "afterSendRequest",
        "afterUpload",
        "beforePackageUpload",
...
AU.javaControl.prototype = {
    ...
    _simpleProperties: [
        { name: "codeBase", defaultValue: "Scripts/ImageUploader7.jar", isAttribute: true, platform: 'java' },
        { name: "className", defaultValue: "com.aurigma.imageuploader.ImageUploader.class", isAttribute: true, platform: 'java' },
        { name: "cached", defaultValue: true, isAttribute: true, platform: 'java' },
        { name: "version", isAttribute: true, platform: 'java', defaultValue: jVERSION }
    ],
...
AU.javaControl.init = propertyMaker._typicalInit;
AU.javaControl.reinit = propertyMaker._typicalReinit;
...
AU.metadata.reinit = function (obj) {
    ...
    obj.addCookie = function (value) {
        if (typeof element.AddCookie == 'undefined') {
    ...
    obj.resetCookie = function () {
        if (typeof element.ResetCookie == 'undefined') {
...
AU.folderPane.prototype = {
    ...
    _simpleProperties: [
        ...
        { name: "headerAllowedText", getter: 1, setter: 1, render: "FolderPaneHeaderAllowedText" },
        { name: "headerAllText", getter: 1, setter: 1, render: "FolderPaneHeaderAllText" },
    ...
    headerAllowedText: function (value) {
        ///	<summary>
        ///		Allowed fiels header text
        ///	</summary>
        ///	<param name="value" type="String" />
        ///	<returns type="String" />
        /* will be created while initialization */
    },
    headerAllText: function (value) {
        ///	<summary>
        ///		All files header text
        ///	</summary>
        ///	<param name="value" type="String" />
        ///	<returns type="String" />
        /* will be created while initialization */
        ...
        if (arguments.length > 0) {
            ...
            if (this._redirectUrl) {
                ...
                this._afterUpload = function () {
                    setTimeout(function () { wnd.location = self._redirectUrl; }, 100);
                }
...
extend(AU.uploader.fn, {
    ...
    _objectProperties: [
        { name: "activeXControl", type: AU.activeXControl },
        ...
        { name: "javaControl", type: AU.javaControl },
    ...
    activeXControl: AU.activeXControl,
...
AU.thumbnail = function (initObj) {
	...
	if (!(typeof initObj === 'string')) {
		// set default values
		initObj = initObj || {};
		initObj.activeXControl = initObj.activeXControl || {};
		initObj.activeXControl.classId = initObj.activeXControl.classId || "6F697589-E15F-4935-BE4F-8F76A68D6E06";
		initObj.activeXControl.progId = initObj.activeXControl.progId || "Aurigma.Thumbnail.7";
		initObj.javaControl = initObj.javaControl || {};
		initObj.javaControl.className = initObj.javaControl.className || "com.aurigma.imageuploader.Thumbnail.class";
	}
    ...
    var getHtml = function () {
        ...
        if (useObjectTag) {
            ...
            if (!browser.isIE64) {
                ...
                attributes.codebase = wnd.location.protocol +
        ...
        if (tagName === 'embed') {
            for (var i = 0, maxi = params.length; i < maxi; i++) {
                var param = params[i];
                html.push(param.name + '="' + param.value + '" ');
            }
            html.push('>');
        } else {
            html.push('>');
            for (var i = 0, maxi = params.length; i < maxi; i++) {
                var param = params[i];
                html.push('<param name="' + param.name + '" value="' + param.value + '" />');
            }
        }
        ...
        // from javascript.
        if (/mac/i.test(wnd.navigator.platform) && /firefox/i.test(wnd.navigator.userAgent) && ('java' in wnd)) {
            wnd.java.lang.System.getProperty('java.version');
        }
