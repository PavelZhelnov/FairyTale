...
var TodayColor="#999999";//Background color of today.
...
function FormatDate(pDate)
{
	if (this.Format.toUpperCase()=="DDMMYYYY")
		...
		return (LeadingZero( pDate )+DateSeparator+LeadingZero( this.GetMonthIndex(this.GetMonthName(false)) )+DateSeparator+this.Year);
	else if (this.Format.toUpperCase()=="MMDDYYYY")
		return (LeadingZero (this.Month+1) +DateSeparator+LeadingZero(pDate)+DateSeparator+this.Year);
	else if (this.Format.toUpperCase()=="MMMDDYYYY")
		return (this.GetMonthName(false)+DateSeparator+pDate+DateSeparator+this.Year);			
}

function LeadingZero(number) {
	if (parseInt(number)<10) {return "0"+number;} else {return number;}
}
